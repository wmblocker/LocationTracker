...
/// <reference path="plugins/AdMob.d.ts"/>
...
/// <reference path="plugins/mocha.d.ts"/>
/// <reference path="plugins/assert.d.ts"/>
/// <reference path="plugins/codePush.d.ts"/>
/// <reference path="plugins/mkdirp.d.ts"/>
/// <reference path="plugins/q.d.ts"/>
/// <reference path="plugins/replace.d.ts"/>
